    ...
    const highlights = [
        {
            ...
            text: "Laurea Triennale in DAMS presso Roma Tre e Laurea Magistrale in Scrittura e Produzioni dello Spettacolo e dei Media presso La Sapienza (in corso)"
        },
        {
            icon: <Globe size={20} />,
                ...
                <div className="flex flex-col md:flex-row gap-16 border-t border-white/10 pt-16">
                    ...
                    <article className="w-full md:w-2/3">
                        ...
                        <div className="space-y-6 text-gray-300 font-sans leading-relaxed text-lg">
                            ...
                            <p>
                                La sua formazione è un mosaico di studio e dedizione: dalla Laurea Triennale in <strong>Arti e Scienze dello Spettacolo (DAMS) presso Roma Tre </strong> al percorso magistrale in Scrittura e Produzione dello Spettacolo e dei Media presso <strong>La Sapienza</strong>. Letizia non ha mai smesso di perfezionarsi. Attrice, mima e ballerina, ha studiato con grandi maestri come <strong>Lina Sastri</strong> e ha affinato le sue doti fisiche e vocali diplomandosi presso <strong>L'Accademia Unika di Bari</strong> e attraverso workshop intensivi e laboratori coreografici internazionali.
                            </p>
                            <p>
                                La sua carriera si è sviluppata all'interno dei teatri più prestigiosi d'Italia. Dall’<strong>Arena di Verona</strong>, dove ha lavorato come mima e ballerina in produzioni quali <em>Carmen</em>, <em>Aida</em> e <em>La Bohème</em>, fino al <strong>Teatro dell’Opera di Roma</strong> e al <strong>Teatro Petruzzelli di Bari</strong>. La sua versatilità artistica l'ha portata a collaborare con importanti registi della scena teatrale e operistica, tra cui <strong>Franco Zeffirelli</strong>, <strong>Stefano Poda</strong>, <strong>Mario Martone</strong>,<strong>Chiara Muti</strong>,<strong>Manu Lalli</strong>,<strong>Simon Stone</strong> e <strong>Pierluigi Pizzi</strong>, oltre ad altri protagonisti di rilievo del panorama nazionale e internazionale.
                            </p>
                            <p>
