...
const LegalLayout: React.FC<LegalLayoutProps> = ({ title, subtitle, icon, children }) => (
  <section className="bg-portfolio-black text-white py-32 px-6 min-h-screen">
    <div className="container mx-auto max-w-3xl">
      ...
      <Link 
        to="/" 
        className="inline-flex items-center gap-2 text-gray-500 hover:text-white transition-colors mb-12 uppercase tracking-widest text-xs"
      >
      ...
      <h1 className="text-5xl md:text-7xl font-serif mb-12 italic">
        {title}
      </h1>

      <div className="h-px w-full bg-gradient-to-r from-white/20 to-transparent mb-16"></div>
      ...
      <div className="mt-20 pt-10 border-t border-white/5 text-sm text-gray-600 italic">
...
export const PrivacyPolicy: React.FC = () => (
  ...
  >
    ...
    <div>
      ...
      <p>
        Hai il diritto di richiedere l'accesso, la rettifica o la cancellazione dei tuoi dati in qualsiasi momento. Per ogni richiesta, puoi scrivere direttamente a: <span className="text-white border-b border-white/20">letiziagiannoccaro20@gmail.com</span>.
      </p>
    </div>
  </LegalLayout>
);
